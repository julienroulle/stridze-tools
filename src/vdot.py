...
def user_VDOT(distance, units, time):
    ...
    print(target)
    print(velocity_to_min_per_km(get_velocity_from_VO2(VDOT)))
    print(velocity_to_min_per_km(get_velocity_from_VO2(VDOT) * 0.95))
    print(velocity_to_min_per_km(get_velocity_from_VO2(VDOT) * 0.85))
    return VDOT
